...
*/
		...
		if (metrics.widthPixels >= 600) {
			rParam = new RelativeLayout.LayoutParams(180, 60);
			btnBack.setTextSize(24);
			btnBack.setPadding(8, 5, 0, 0);
		} else {
			rParam = new RelativeLayout.LayoutParams(110, 50);
			btnBack.setPadding(5, 5, 0, 0);
		}
		btnBack.setText("");
		rParam.setMargins(5, 5, 5, 5);
		btnBack.setLayoutParams(rParam);
